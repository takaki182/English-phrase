...
const text = readFileSync('/Users/takakitakeda/Documents/Learning/English/drama_english.txt', 'utf8');
...
console.error(`Parsed ${phrases.length} drama phrases`);
writeFileSync('drama_phrases.json', JSON.stringify(phrases));
